...
Function `fs_pivot4` first identifies the start and end of the fishing season for each year, and calculates the proportion of each week that fishing occurs for each fleet. It then joins the proportion of week fished to the output from function `fs_pivot3`. 
```{r, warning = FALSE, message = FALSE}
